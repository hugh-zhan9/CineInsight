...
- **智能与保存视图**: 内置继续观看、收藏、最近播放、未看、已看、最近添加、未打标签、无字幕和路径失效视图，并可保存任意筛选组合。
...
7. **浏览与续播**: 切换列表/网格，点击"预览"在右侧抽屉中查看并保存进度
8. **按条件随机**: 选择均衡、未看或收藏模式，在当前筛选范围内随机播放
9. **播放/打开**: 点击"播放"使用默认播放器，点击"打开目录"查看文件位置
10. **安全清理**: 在清理候选中预览重复与同源版本，确认后移入回收站
