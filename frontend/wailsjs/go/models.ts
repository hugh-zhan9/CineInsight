...
export namespace services {
	...
	export class EnhancementTaskView {
	    ...
	    static createFrom(source: any = {}) {
	        return new EnhancementTaskView(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.output_basename = source["output_basename"];
	        this.total_frames = source["total_frames"];
	        this.committed_frames = source["committed_frames"];
	...
	export class EnhancementVideoPreflight {
	    output_basename_general: string;
	    output_basename_anime: string;
	    required_bytes: number;
	    free_bytes: number;
	
	    static createFrom(source: any = {}) {
	        return new EnhancementVideoPreflight(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.output_basename_general = source["output_basename_general"];
	        this.output_basename_anime = source["output_basename_anime"];
	...
	export class LocalMetadataExportStatus {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.updated_at = source["updated_at"];
	        this.failures = this.convertValues(source["failures"], LocalMetadataFailure);
	        this.failures_truncated = source["failures_truncated"];
	    }
	...
	export class RandomPickResult {
	    ...
	    static createFrom(source: any = {}) {
	        return new RandomPickResult(source);
	    }
